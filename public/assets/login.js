const discord = {
  ...
  login: (i) => {
    ...
    codeInfo.innerHTML = "<span class='cob'>Login With Code</span>Enter This Code on any Logged in Device to Instantly Start Chatting."
    inputCont.innerHTML = `<div style="width:100%"><span class="title-login">Welcome Back!</span><input id="user" placeholder="Email"><input type="password" id="pass" placeholder="Password"><input type="submit" value="Continue"></div>`
